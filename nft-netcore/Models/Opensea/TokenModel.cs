// Root myDeserializedClass = JsonSerializer.Deserialize<Token>(myJsonResponse);

using System.Text.Json.Serialization;

namespace Nft.Models.Opensea;
...
public record Asset(
    ...
    public record PaymentToken(
        ...
        [property: JsonPropertyName("eth_price")] double EthPrice,
        [property: JsonPropertyName("usd_price")] double UsdPrice
    );

    public record PaymentToken2(
        [property: JsonPropertyName("symbol")] string Symbol,
        [property: JsonPropertyName("address")] string Address,
        [property: JsonPropertyName("image_url")] string ImageUrl,
        [property: JsonPropertyName("name")] string Name,
        [property: JsonPropertyName("decimals")] int Decimals,
        [property: JsonPropertyName("eth_price")] string EthPrice,
        [property: JsonPropertyName("usd_price")] string UsdPrice
    );
    ...
    // public record SellerFees(
    //     [property: JsonPropertyName("0xaae7ac476b117bccafe2f05f582906be44bc8ff1")] int _0xaae7ac476b117bccafe2f05f582906be44bc8ff1
    // );
